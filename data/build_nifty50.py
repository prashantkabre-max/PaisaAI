...
NIFTY200_URL = "https://archives.nseindia.com/content/indices/ind_nifty50list.csv"
...
def main():
    ...
    print("Downloading NIFTY 50 constituents...")
    ...
    with open("data/nifty50.py", "w") as f:
        f.write('"""\n')
        ...
        f.write("}\n\n")
        f.write("NIFTY50 = list(SYMBOL_MAP.keys())\n")
